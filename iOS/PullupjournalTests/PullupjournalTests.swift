import XCTest
@testable import Pullupjournal

@MainActor
final class PullupjournalTests: XCTestCase {
    ...
    func testFreeTierLimitBlocksAdd() {
        ...
        let result = store.add(PullupEntry())
    ...
    func testPersistenceRoundTrip() {
        let store = makeStore()
        _ = store.add(PullupEntry(notes: "persisted"))
        let reloaded = Store()
